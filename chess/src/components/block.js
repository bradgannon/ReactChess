...
export default class Block extends Component {
  ...
  renderPieces() {
    ...
    } else if (this.props instanceof RookPiece) {
      return this.renderRook();
    } else if (this.props instanceof BishopPiece) {
      return this.renderBishop();
    } else if (this.props instanceof KnightPiece) {
      return this.renderKnight();
    } else if (this.props instanceof QueenPiece) {
      return this.renderQueen();
    } else if (this.props instanceof KingPiece) {
  ...
  render() {
    return (
      <div className="block">
        <button onClick={this.props.onClick} className={this.isDark ? "block-dark" : "block-light"}>
          {this.renderPieces()}
        </button>
      </div>
    )
